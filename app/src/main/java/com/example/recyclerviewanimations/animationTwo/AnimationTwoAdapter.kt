...
class AnimationTwoAdapter(private val dataSet: List<Int>) :
  RecyclerView.Adapter<AnimationTwoAdapter.ViewHolder>() {
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
    holder.cardView.animation =
      AnimationUtils.loadAnimation(holder.itemView.context, R.anim.animation_two)
  }
